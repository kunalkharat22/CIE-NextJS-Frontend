export const SCREENSHOTS = [
  { 
    src: "/screens/01-login.png", 
    caption: "Login & Secure Access",
    info: "Clean authentication screen for SMEs to securely access the CIE platform. Supports email login, password recovery, and persistent sessions with GDPR-compliant security."
  },
  { 
  ...
  { 
    src: "/screens/03.2-Complaint-Intake-Score.png", 
    caption: "AI Scoring & Risk Assessment",
    info: "AI-powered scoring engine that evaluates complaint severity, risk level, priority queue, and churn probability. Includes explainability analysis with detected signals and automated action recommendations."
  },
  ...
  // { 
  //   src: "/screens/06-Settings.png", 
  //   caption: "Platform Settings & Preferences",
  //   info: "Centralized system configuration for notifications, display preferences, integrations, and security controls, enabling teams to tailor CIE to their operational needs."
  // }
];

export const VIDEO_EMBED_URL = "https://www.youtube.com/embed/36tpSQnwS3k?si=hofyHe3HHeg0qkU8";
